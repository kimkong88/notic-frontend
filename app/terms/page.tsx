                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-invert max-w-none space-y-8 text-[var(--text-secondary)] leading-relaxed">
                        <section>
                            ...
                            <p>
                                By accessing or using Notic
                                (&quot;Service&quot;), you agree to be bound by
                                these Terms of Service (&quot;Terms&quot;). If
                                you disagree with any part of these terms, you
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                <li>
                                    <strong>Free (Personal):</strong> 2 floating
                                    windows, unlimited sync across devices when
                                    you sign in, unlimited notes in the browser,
                                    markdown, folders, and images. Export to .md
                                    is included.
                                </li>
                                <li>
                                    <strong>Pro:</strong> Unlimited floating
                                    windows, unlimited synced notes, plus
                                    priority support. Available as a monthly
                                    subscription ($3.99/month) or yearly
                                    subscription ($29.99/year). Billing is
                                    processed through Lemon Squeezy.
                                </li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                <li>
                                    ...
                                    Lemon Squeezy. You provide payment details
                                    to Lemon Squeezy; we do not store your full
                                    payment information.
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    through your account or by contacting
                                    support. Cancellation takes effect at the
                                    end of your current billing period; you
                                    retain access to Pro features until then.
                                </li>
                                <li>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>
                                    Use the Service to infringe upon the rights
                                    of others, including intellectual property
                                    rights
                                </li>
                                <li>
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                features, and functionality, is owned by Notic
                                and protected by applicable copyright,
                                trademark, and other intellectual property laws.
                                You may not copy, modify, distribute, or create
                                derivative works based on the Service without
                                our express written permission. Your notes and
                                data remain yours; we do not claim ownership of
                                your content.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                services (e.g. Google for sign-in, Lemon Squeezy
                                for billing, Chrome Web Store for distribution,
                                and optional integrations such as Notion or
                                Obsidian). Your use of those services is subject
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                your access to the Service (including sync and
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                use of the Service after changes become

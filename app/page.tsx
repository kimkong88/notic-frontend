  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] selection:bg-[var(--accent-light)]">
      ...
      <main>
        ...
        <section id="features" aria-labelledby="features-heading" className="bento-section py-20 sm:py-24 md:py-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="mb-16 sm:mb-20 text-center">
              <h2 id="features-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--text-primary)] mb-4 sm:mb-6 md:mb-8 tracking-tight">
                Built for how you work.
              </h2>
              <p className="text-[var(--text-muted)] text-base sm:text-lg md:text-xl lg:text-2xl max-w-2xl mx-auto leading-relaxed">
                No more hunting for that tab with your scratchpad. Notic floats over every tab and stays where you need it.
              </p>
            </div>

            <div className="bento-grid grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(280px,auto)]">
              {/* Always in sight – differentiator */}
              <div className="bento-card md:col-span-2 card rounded-2xl sm:rounded-3xl p-8 sm:p-10 relative overflow-hidden group" tabIndex={0}>
                <div className="relative z-10 flex flex-col h-full justify-between">
                  <div>
                    ...
                    <p className="text-[var(--text-muted)] text-sm sm:text-base md:text-lg max-w-md leading-relaxed">
                      Notic floats over every tab. Move from Gmail to Docs to code—your note stays exactly where you pinned it. No switching tabs.
                    </p>
                  </div>
                </div>
              ...
              <div className="bento-card card rounded-2xl sm:rounded-3xl p-8 sm:p-10 flex flex-col justify-between group" tabIndex={0}>
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-[var(--accent-light)] flex items-center justify-center mb-6 sm:mb-8">
                  ...
                  <p className="text-[var(--text-muted)] text-sm sm:text-base md:text-lg leading-relaxed">
                    Multiple notes in one floating window. Switch between meeting notes, tasks, and scratch without leaving the tab you&apos;re on.
                  </p>
                </div>
              </div>
              ...
              <div className="bento-card card rounded-2xl sm:rounded-3xl p-8 sm:p-10 flex flex-col justify-between group" tabIndex={0}>
                <div>
                  ...
                  <p className="text-[var(--text-muted)] text-sm sm:text-base md:text-lg leading-relaxed mb-4">
                    Connect your notes to the tools you already use. Notion and Obsidian integrations included.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <span className="inline-flex items-center px-3 py-1 rounded-lg bg-[var(--bg-tertiary)] border border-[var(--border-primary)] text-xs font-medium text-[var(--text-secondary)]">Notion</span>
                    <span className="inline-flex items-center px-3 py-1 rounded-lg bg-[var(--bg-tertiary)] border border-[var(--border-primary)] text-xs font-medium text-[var(--text-secondary)]">Obsidian</span>
                  </div>
                </div>
              </div>

              {/* Publish & share – spans 2 cols to fill row */}
              <div className="bento-card md:col-span-2 card rounded-2xl sm:rounded-3xl p-8 sm:p-10 flex flex-col justify-between group" tabIndex={0}>
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-[var(--accent-light)] flex items-center justify-center mb-6 sm:mb-8">
                  ...
                  <p className="text-[var(--text-muted)] text-sm sm:text-base md:text-lg leading-relaxed">
                    Share a note as a link or publish it so others can view it. Great for meeting notes, specs, and read-only handoffs.
                  </p>
                </div>
              </div>

              {/* Sync across devices – full width row */}
              <div className="bento-card md:col-span-3 card rounded-2xl sm:rounded-[2rem] p-8 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16 overflow-hidden" tabIndex={0}>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[var(--text-muted)] text-sm sm:text-base md:text-lg max-w-md leading-relaxed">
                    Your notes travel with you. Start at work, finish at home. Free tier includes 10 synced notes; upgrade to Pro for unlimited.
                  </p>
                </div>
                <div className="flex-1 w-full max-w-lg flex items-center justify-center gap-6 sm:gap-8">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-[10px] text-[var(--text-muted)] font-mono uppercase">Work</span>
                  </div>
                  <div className="text-[var(--accent)]/50 animate-pulse" aria-hidden>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-[10px] text-[var(--accent)] font-mono uppercase font-medium">Home</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Privacy / Data */}
        <section id="data" className="py-16 sm:py-24 md:py-32 bg-[var(--bg-secondary)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div className="text-center md:text-left">
              ...
              <p className="text-[var(--text-muted)] text-base sm:text-lg md:text-xl mb-6 sm:mb-8 leading-relaxed max-w-lg mx-auto md:mx-0">
                Notic is local-first and works offline. Notes live in your browser—we don&apos;t mine them for AI or sell usage data. Export to .md anytime; when you leave, take everything with you.
              </p>
            ...
            <div className="relative">
              <div className="card rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <span className="text-[var(--text-primary)] font-semibold block">Notic_Export.zip</span>
                    <span className="text-[var(--text-muted)] text-xs">Export anytime from the extension</span>
                  </div>
                </div>
                <div className="space-y-3">
                  {[
                    ...
                    >
                      ...
                      <span className="text-[var(--text-muted)] text-sm">{folder.files} notes</span>
                    </div>
                  ))}
                </div>
                <button
                ...
                >
                  <Download className="w-5 h-5 shrink-0" /> One-click export
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-8 sm:mb-10">
              ...
              <p className="text-[var(--text-muted)] text-base sm:text-lg md:text-xl max-w-xl mx-auto">
                No sign-up to write. No hunting for that tab. No lock-in.
              </p>
            </div>
            ...
            <div className="space-y-6 sm:space-y-7 text-[var(--text-secondary)]">
              <div className="card p-5 sm:p-6 md:p-7 rounded-2xl sm:rounded-3xl">
                <p className="text-base sm:text-lg md:text-xl leading-relaxed text-left sm:text-center">
                  You shouldn’t need an account just to capture a thought. Install the extension, start writing. <span className="text-[var(--accent)] font-semibold">No email, no credit card.</span>
                </p>
              </div>

              <div className="card p-5 sm:p-6 md:p-7 rounded-2xl sm:rounded-3xl">
                <p className="text-base sm:text-lg md:text-xl leading-relaxed text-left sm:text-center">
                  When you want the same notes on another laptop or browser, turn on sync. Start with a few for free; go Pro when it’s worth it for you.
                </p>
              </div>

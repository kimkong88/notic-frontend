  ...
  return (
    <section className="pt-40 sm:pt-48 pb-28 sm:pb-36 px-6 overflow-hidden relative">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 80% 50% at 50% 20%, rgba(79, 70, 229, 0.06) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          One window over your browser. Stays open while you switch tabs—Markdown, folders, sync. No hunting for that tab.
        </motion.p>
        ...
        >
          <div className="card rounded-xl sm:rounded-2xl p-5 sm:p-6 flex flex-col gap-3 text-left">
            <div className="flex items-center gap-3">
              ...
              <h4 className="text-base font-semibold text-[var(--text-primary)]">Minimal</h4>
            </div>
            <p className="text-[var(--text-muted)] text-sm leading-relaxed">
              No bloat, no templates, no complexity. Notes that stay out of your way—unlike heavy editors.
            </p>
          </div>
          <div className="card rounded-xl sm:rounded-2xl p-5 sm:p-6 flex flex-col gap-3 text-left">
            <div className="flex items-center gap-3">
              ...
              <h4 className="text-base font-semibold text-[var(--text-primary)]">Markdown</h4>
            </div>
            <p className="text-[var(--text-muted)] text-sm leading-relaxed">
              Write in Markdown, images, checklists. Export to .md—your format, portable. No lock-in.
            </p>
          </div>
          <div className="card rounded-xl sm:rounded-2xl p-5 sm:p-6 flex flex-col gap-3 text-left">
            <div className="flex items-center gap-3">
              ...
              <h4 className="text-base font-semibold text-[var(--text-primary)]">Organization</h4>
            </div>
            <p className="text-[var(--text-muted)] text-sm leading-relaxed">
              Folders and tabs. Find what you need without a sidebar the size of a filing cabinet.
            </p>
          </div>
          <div className="card rounded-xl sm:rounded-2xl p-5 sm:p-6 flex flex-col gap-3 text-left">
            <div className="flex items-center gap-3">
              ...
              <h4 className="text-base font-semibold text-[var(--text-primary)]">Theme</h4>
            </div>
            <p className="text-[var(--text-muted)] text-sm leading-relaxed">
              Light, dark, or match your system. One click—no design fatigue from heavy apps.
            </p>
          </div>
        </motion.div>
      </div>

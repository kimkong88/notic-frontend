    ...
    <nav className="fixed w-full z-50 top-0 left-0 bg-black/40 backdrop-blur-xl border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-6 lg:gap-8 text-sm font-medium text-gray-400">
          ...
          <a href={CHROME_STORE_URL} className="hover:text-[#E63946] transition-colors">Install</a>
        </div>

        <a 
          href="#pricing" 
          className="bg-[#E63946] hover:brightness-110 px-4 sm:px-6 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-bold transition-all hover:translate-y-[-2px] hover:shadow-[0_12px_24px_rgba(230,57,70,0.3)]"
        >
          Get Premium
        </a>
      </div>
